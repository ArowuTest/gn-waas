...
export default function CreditRequestsPage() {
  ...
  const handleExport = () => {
    exportToCSV(creditList, [
      ...
      { header: 'Overcharge (GHS)', accessor: (r) => ((r as CreditRequest).overcharge_amount_ghs ?? 0).toFixed(2) },
      { header: 'Credit (GHS)',     accessor: (r) => ((r as CreditRequest).credit_amount_ghs ?? 0).toFixed(2) },
