...
export const MOCK_ANOMALY_FLAGS = [
  { id: 'flag-001', flag_reference: 'ANF-2026-0847', district_id: 'dist-001', district_name: 'Accra Metropolitan', account_id: 'acc-001', account_number: 'GWL-ACC-004821', customer_name: 'Kofi Mensah Enterprises', anomaly_type: 'SHADOW_BILL_VARIANCE', alert_level: 'CRITICAL', status: 'OPEN', estimated_loss_ghs: 48200.00, variance_pct: 67.4, created_at: '2026-03-05T08:14:22Z', updated_at: '2026-03-05T08:14:22Z' },
  { id: 'flag-002', flag_reference: 'ANF-2026-0846', district_id: 'dist-002', district_name: 'Kumasi Metropolitan', account_id: 'acc-002', account_number: 'GWL-KSI-002341', customer_name: 'Ama Boateng Cold Store', anomaly_type: 'UNAUTHORISED_CONSUMPTION', alert_level: 'HIGH', status: 'OPEN', estimated_loss_ghs: 22100.00, variance_pct: 41.2, created_at: '2026-03-05T07:30:11Z', updated_at: '2026-03-05T07:30:11Z' },
...
export const MOCK_REVENUE_SUMMARY = {
  ...
  by_type: [
    ...
    { recovery_type: 'GHOST_ACCOUNT', count: 123, recovered_ghs: 100650.00, success_fee_ghs: 3019.50 },
  ],
}
